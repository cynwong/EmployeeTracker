...
module.exports = {
     ...
     */
    all: function(cb){
        orm.innerJoinSelect(tableName,foreignTable, columnNames,"name", foreignKey, null,null, cb);
    },
    /**
    ...
    select: function(columns, condition, cb){
        ...
        orm.innerJoinSelect(tableName,foreignTable, columns,"name",foreignKey, condition,null, cb);
    },
    /**
    ...
    getRoleByDepartmentName(columns, departmentName, cb){
        ...
        orm.innerJoinSelect(tableName,foreignTable, columns,"name",foreignKey, null,`name="${departmentName}"`, cb);
    },
    ...
    getRoleByDepartmentId(columns, departmentId, cb){
        ...
        orm.innerJoinSelect(tableName,foreignTable, columns,"name",foreignKey, null,`id=${departmentId}`, cb);
    },
