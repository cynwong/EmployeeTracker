...
module.exports = {
    ...
    all: function(sortBy,cb){
        orm.joinAllTables(null, sortBy, cb);
    },
    /**
    ...
    getEmployeeById: function(searchId, cb){
        orm.joinAllTables(`t1.id=${searchId}`,null, cb);
    },
    ...
    getEmployeeByDepartmentId: function(searchId, cb){
        orm.joinAllTables(`t3.id=${searchId}`,null, cb);
    },
    ...
    getEmployeeByRoleId: function(searchId, cb){
        orm.joinAllTables(`t1.role_id=${searchId}`,null, cb);
    },
     ...
     */
    getEmployeeByRoleId: function(searchId, cb){
        orm.joinAllTables(`t1.manager_id=${searchId}`,null, cb);
    },
