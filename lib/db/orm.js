...
module.exports = {
    ...
    joinAllTables: function(condition, sortBy,cb){
        let queryString = "SELECT t1.id as id, t1.first_name as first_name, t1.last_name as last_name, t1.role_id as role_id, t2.title as title, t1.salary as salary, t3.id as department_id, t3.name as department_name, t4.id as manager_id, CONCAT(t4.first_name, \" \", t4.last_name) as manager ";
        let orderBy= null;
